...
public class ConsoleUI {
    ...
    private void menuClaimItem() { 
        ...
        // ask validation questions — category specific, using polymorphism
        Map<String, String> questions = item.getValidationQuestions();
        ...
        // process — all logic handled in ItemService
    ...
    private void menuReportLostItem() {
        ...
        // all logic handled in ItemService
        LostItem item = itemServiceObj.registerLostItem(name, location, category,
    ...
    private void menuViewLostItems() {
        ...
        if (categoryChoice == 5) {
            // no category filter
            if (viewChoice == 1) {
                items = itemServiceObj.getActiveLostItems();
            } else {
                items = itemServiceObj.getExpiredLostItems();
            }
        } else {
            ...
            if (viewChoice == 1) {
                items = itemServiceObj.getActiveLostByCategory(category);
            } else {
                items = itemServiceObj.getExpiredLostByCategory(category);
            }
        }
